...
function Sparkline({ data, color, w, h }) {
    if (data.length < 2)
        return _jsx("svg", { width: w, height: h, children: _jsx("text", { x: 4, y: h / 2 + 4, fill: "rgba(255,255,255,0.3)", fontSize: 11, children: "Not enough data" }) });
