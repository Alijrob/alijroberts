...
export default function Hub({ brand, onBrandRefresh, onLogout }) {
    const [activeModule, setActiveModule] = useState(() => {
        ...
        const valid = ['dashboard', 'agenda', 'crm', 'todo', 'calendar', 'email', 'files', 'operations', 'raven', 'daedalus', 'blueprint', 'newspaper', 'settings', 'apiassist', 'agent-bridges', 'systems', 'projects', 'project-new', 'skills', 'prompt-library', 'prompt-lab', 'prompt-fixes'];
        return valid.includes(hash) ? hash : 'dashboard';
    });
    const [collapsed, setCollapsed] = useState(false);
    return (_jsxs(HubLayout, { activeModule: activeModule, onNavigate: (m) => setActiveModule(m), collapsed: collapsed, onToggle: () => setCollapsed(c => !c), brand: brand, onProfileSaved: onBrandRefresh, onLogout: onLogout, onOpenApiAssist: () => setActiveModule('apiassist'), children: [activeModule === 'dashboard' && _jsx(Dashboard, { brand: brand }), activeModule === 'apiassist' && _jsx(ApiAssist, {}), activeModule === 'files' && _jsx(MediaFiles, {}), activeModule === 'agent-bridges' && _jsx(AgentBridges, {}), activeModule === 'email' && _jsx(EmailModule, {}), activeModule === 'calendar' && _jsx(CalendarModule, {}), activeModule === 'todo' && _jsx(TasksModule, {}), activeModule === 'blueprint' && _jsx(Blueprint, {}), activeModule === 'systems' && _jsx(Systems, {}), activeModule === 'skills' && _jsx(SkillsModule, {}), (activeModule === 'projects' || activeModule === 'project-new') && _jsx(ProjectsView, {}), activeModule === 'prompt-library' && _jsx(PromptCenter, { bucket: "library" }), activeModule === 'prompt-lab' && _jsx(PromptCenter, { bucket: "lab" }), activeModule === 'prompt-fixes' && _jsx(PromptCenter, { bucket: "fixes" }), activeModule !== 'dashboard' && activeModule !== 'apiassist' &&
